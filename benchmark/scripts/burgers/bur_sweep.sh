...
#SBATCH --output=out/burgers/sweep.out
#SBATCH --nodes=1
...
# python -u PDE_Viscous_Burgers.py -m algorithm=pbm \
#     algorithm.primal__lr=0.0005,0.001 \
#     +algorithm.primal__weight_decay=0.01 \
#     algorithm.dual__penalty_mult=0.99,0.999,1. \
...
#     algorithm.dual__pbf=quadratic_logarithmic \
#     algorithm.dual__gamma=0.1,0.9,0.99,0.999 \
#     algorithm.dual__delta=1.0 \
#     algorithm.moreau__mu=1. \
#     seed=0,1,2 \
#     task=burgers \
...
python -u PDE_Viscous_Burgers.py -m algorithm=alm \
    algorithm.primal__lr=0.0005,0.001 \
    +algorithm.primal__weight_decay=0.01 \
    algorithm.dual__lr=0.01 \
    algorithm.dual__penalty=0.,1. \
    algorithm.moreau__mu=1. \
    seed=0,1 \
    task=burgers \
    data=burgers \
